...
!function(d,a,s){function l(t,e,i){var n=a.createElement(t);return e&&(n.id=Z+e),i&&(n.style.cssText=i),d(n)}function c(){return s.innerHeight?s.innerHeight:d(s).height()}function g(t,i){i!==Object(i)&&(i={}),this.cache={},this.el=t,this.value=function(t){var e;return void 0===this.cache[t]&&(void 0!==(e=d(this.el).attr("data-cbox-"+t))?this.cache[t]=e:void 0!==i[t]?this.cache[t]=i[t]:void 0!==X[t]&&(this.cache[t]=X[t])),this.cache[t]},this.get=function(t){var e=this.value(t);return d.isFunction(e)?e.call(this.el,this):e}}function r(t){var e=E.length,i=(A+t)%e;return i<0?e+i:i}function u(t,e){return Math.round((/%/.test(t)?("x"===e?I.width():c())/100:1)*parseInt(t,10))}function f(t,e){return t.get("photo")||t.get("photoRegex").test(e)}function p(t,e){return t.get("retinaUrl")&&1<s.devicePixelRatio?e.replace(t.get("photoRegex"),t.get("retinaSuffix")):e}function m(t){"contains"in y[0]&&!y[0].contains(t.target)&&t.target!==x[0]&&(t.stopPropagation(),y.focus())}function w(t){w.str!==t&&(y.add(x).removeClass(w.str).addClass(t),w.str=t)}function v(t){d(a).trigger(t),at.triggerHandler(t)}function n(t){var e;if(!G){if(e=d(t).data(Y),function(t){A=0,t&&!1!==t&&"nofollow"!==t?(E=d("."+tt).filter(function(){return new g(this,d.data(this,Y)).get("rel")===t}),-1===(A=E.index(_.el))&&(E=E.add(_.el),A=E.length-1)):E=d(_.el)}((_=new g(t,e)).get("rel")),!U){U=$=!0,w(_.get("className")),y.css({visibility:"hidden",display:"block",opacity:""}),M=l(st,"LoadedContent","width:0; height:0; overflow:hidden; visibility:hidden"),T.css({width:"",height:""}).append(M),j=C.height()+W.height()+T.outerHeight(!0)-T.height(),D=H.width()+k.width()+T.outerWidth(!0)-T.width(),N=M.outerHeight(!0),z=M.outerWidth(!0);var i=u(_.get("initialWidth"),"x"),n=u(_.get("initialHeight"),"y"),o=_.get("maxWidth"),r=_.get("maxHeight");_.w=Math.max((!1!==o?Math.min(i,u(o,"x")):i)-z-D,0),_.h=Math.max((!1!==r?Math.min(n,u(r,"y")):n)-N-j,0),M.css({width:"",height:_.h}),J.position(),v(et),_.get("onOpen"),O.add(R).hide(),y.focus(),_.get("trapFocus")&&a.addEventListener&&(a.addEventListener("focus",m,!0),at.one(rt,function(){a.removeEventListener("focus",m,!0)})),_.get("returnFocus")&&at.one(rt,function(){d(_.el).focus()})}var h=parseFloat(_.get("opacity"));x.css({opacity:h==h?h:"",cursor:_.get("overlayClose")?"pointer":"",visibility:"visible"}).show(),_.get("closeButton")?B.html(_.get("close")).appendTo(T):B.appendTo("<div/>"),function(){var t,e,i,n=J.prep,o=++lt;if(q=!($=!0),v(ht),v(it),_.get("onLoad"),_.h=_.get("height")?u(_.get("height"),"y")-N-j:_.get("innerHeight")&&u(_.get("innerHeight"),"y"),_.w=_.get("width")?u(_.get("width"),"x")-z-D:_.get("innerWidth")&&u(_.get("innerWidth"),"x"),_.mw=_.w,_.mh=_.h,_.get("maxWidth")&&(_.mw=u(_.get("maxWidth"),"x")-z-D,_.mw=_.w&&_.w<_.mw?_.w:_.mw),_.get("maxHeight")&&(_.mh=u(_.get("maxHeight"),"y")-N-j,_.mh=_.h&&_.h<_.mh?_.h:_.mh),t=_.get("href"),Q=setTimeout(function(){F.show()},100),_.get("inline")){var r=d(t).eq(0);i=d("<div>").hide().insertBefore(r),at.one(ht,function(){i.replaceWith(r)}),n(r)}else _.get("iframe")?n(" "):_.get("html")?n(_.get("html")):f(_,t)?(t=p(_,t),q=_.get("createImg"),d(q).addClass(Z+"Photo").bind("error."+Z,function(){n(l(st,"Error").html(_.get("imgError")))}).one("load",function(){o===lt&&setTimeout(function(){var t;_.get("retinaImage")&&1<s.devicePixelRatio&&(q.height=q.height/s.devicePixelRatio,q.width=q.width/s.devicePixelRatio),_.get("scalePhotos")&&(e=function(){q.height-=q.height*t,q.width-=q.width*t},_.mw&&q.width>_.mw&&(t=(q.width-_.mw)/q.width,e()),_.mh&&q.height>_.mh&&(t=(q.height-_.mh)/q.height,e())),_.h&&(q.style.marginTop=Math.max(_.mh-q.height,0)/2+"px"),E[1]&&(_.get("loop")||E[A+1])&&(q.style.cursor="pointer",d(q).bind("click."+Z,function(){J.next()})),q.style.width=q.width+"px",q.style.height=q.height+"px",n(q)},1)}),q.src=t):t&&L.load(t,_.get("data"),function(t,e){o===lt&&n("error"===e?l(st,"Error").html(_.get("xhrError")):d(this).contents())})}()}}function o(){y||(V=!1,I=d(s),y=l(st).attr({id:Y,class:!1===d.support.opacity?Z+"IE":"",role:"dialog",tabindex:"-1"}).hide(),x=l(st,"Overlay").hide(),F=d([l(st,"LoadingOverlay")[0],l(st,"LoadingGraphic")[0]]),b=l(st,"Wrapper"),T=l(st,"Content").append(R=l(st,"Title"),h=l(st,"Current"),P=d('<button type="button"/>').attr({id:Z+"Previous"}),K=d('<button type="button"/>').attr({id:Z+"Next"}),S=d('<button type="button"/>').attr({id:Z+"Slideshow"}),F),B=d('<button type="button"/>').attr({id:Z+"Close"}),b.append(l(st).append(l(st,"TopLeft"),C=l(st,"TopCenter"),l(st,"TopRight")),l(st,!1,"clear:left").append(H=l(st,"MiddleLeft"),T,k=l(st,"MiddleRight")),l(st,!1,"clear:left").append(l(st,"BottomLeft"),W=l(st,"BottomCenter"),l(st,"BottomRight"))).find("div div").css({float:"left"}),L=l(st,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=K.add(P).add(h).add(S)),a.body&&!y.parent().length&&d(a.body).append(x,y.append(b,L))}var x,y,b,T,C,H,k,W,E,I,M,L,F,R,h,S,K,P,B,O,_,j,D,N,z,A,q,U,$,G,Q,J,V,X={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,opacity:.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,loop:!0,slideshow:!1,slideshowAuto:!0,slideshowSpeed:2500,slideshowStart:"start slideshow",slideshowStop:"stop slideshow",photoRegex:/\.(gif|png|jp(e|g|eg)|bmp|ico|webp|jxr|svg)((#|\?).*)?$/i,retinaImage:!1,retinaUrl:!1,retinaSuffix:"@2x.$1",current:"image {current} of {total}",previous:"previous",next:"next",close:"close",xhrError:"This content failed to load.",imgError:"This image failed to load.",returnFocus:!0,trapFocus:!0,onOpen:!1,onLoad:!1,onComplete:!1,onCleanup:!1,onClosed:!1,rel:function(){return this.rel},href:function(){return d(this).attr("href")},title:function(){return this.title},createImg:function(){var i=new Image,t=d(this).data("cbox-img-attrs");return"object"==typeof t&&d.each(t,function(t,e){i[t]=e}),i},createIframe:function(){var i=a.createElement("iframe"),t=d(this).data("cbox-iframe-attrs");return"object"==typeof t&&d.each(t,function(t,e){i[t]=e}),"frameBorder"in i&&(i.frameBorder=0),"allowTransparency"in i&&(i.allowTransparency="true"),i.name=(new Date).getTime(),i.allowFullscreen=!0,i}},Y="colorbox",Z="cbox",tt=Z+"Element",et=Z+"_open",it=Z+"_load",nt=Z+"_complete",ot=Z+"_cleanup",rt=Z+"_closed",ht=Z+"_purge",at=d("<a/>"),st="div",lt=0,dt={},ct=function(){function t(){clearTimeout(h)}function e(){(_.get("loop")||E[A+1])&&(t(),h=setTimeout(J.next,_.get("slideshowSpeed")))}function i(){S.html(_.get("slideshowStop")).unbind(s).one(s,n),at.bind(nt,e).bind(it,t),y.removeClass(a+"off").addClass(a+"on")}function n(){t(),at.unbind(nt,e).unbind(it,t),S.html(_.get("slideshowStart")).unbind(s).one(s,function(){J.next(),i()}),y.removeClass(a+"on").addClass(a+"off")}function o(){r=!1,S.hide(),t(),at.unbind(nt,e).unbind(it,t),y.removeClass(a+"off "+a+"on")}var r,h,a=Z+"Slideshow_",s="click."+Z;return function(){r?_.get("slideshow")||(at.unbind(ot,o),o()):_.get("slideshow")&&E[1]&&(r=!0,at.one(ot,o),_.get("slideshowAuto")?i():n(),S.show())}}();d[Y]||(d(o),(J=d.fn[Y]=d[Y]=function(e,t){var i=this;return e=e||{},d.isFunction(i)&&(i=d("<a/>"),e.open=!0),i[0]&&(o(),function(){function t(t){1<t.which||t.shiftKey||t.altKey||t.metaKey||t.ctrlKey||(t.preventDefault(),n(this))}return!!y&&(V||(V=!0,K.click(function(){J.next()}),P.click(function(){J.prev()}),B.click(function(){J.close()}),x.click(function(){_.get("overlayClose")&&J.close()}),d(a).bind("keydown."+Z,function(t){var e=t.keyCode;U&&_.get("escKey")&&27===e&&(t.preventDefault(),J.close()),U&&_.get("arrowKey")&&E[1]&&!t.altKey&&(37===e?(t.preventDefault(),P.click()):39===e&&(t.preventDefault(),K.click()))}),d.isFunction(d.fn.on)?d(a).on("click."+Z,"."+tt,t):d("."+tt).live("click."+Z,t)),!0)}()&&(t&&(e.onComplete=t),i.each(function(){var t=d.data(this,Y)||{};d.data(this,Y,d.extend(t,e))}).addClass(tt),new g(i[0],e).get("open")&&n(i[0]))),i}).position=function(e,t){function i(){C[0].style.width=W[0].style.width=T[0].style.width=parseInt(y[0].style.width,10)-D+"px",T[0].style.height=H[0].style.height=k[0].style.height=parseInt(y[0].style.height,10)-j+"px"}var n,o,r,h=0,a=0,s=y.offset();if(I.unbind("resize."+Z),y.css({top:-9e4,left:-9e4}),o=I.scrollTop(),r=I.scrollLeft(),_.get("fixed")?(s.top-=o,s.left-=r,y.css({position:"fixed"})):(h=o,a=r,y.css({position:"absolute"})),a+=!1!==_.get("right")?Math.max(I.width()-_.w-z-D-u(_.get("right"),"x"),0):!1!==_.get("left")?u(_.get("left"),"x"):Math.round(Math.max(I.width()-_.w-z-D,0)/2),h+=!1!==_.get("bottom")?Math.max(c()-_.h-N-j-u(_.get("bottom"),"y"),0):!1!==_.get("top")?u(_.get("top"),"y"):Math.round(Math.max(c()-_.h-N-j,0)/2),y.css({top:s.top,left:s.left,visibility:"visible"}),b[0].style.width=b[0].style.height="9999px",n={width:_.w+z+D,height:_.h+N+j,top:h,left:a},e){var l=0;d.each(n,function(t){return n[t]!==dt[t]?void(l=e):void 0}),e=l}dt=n,e||y.css(n),y.dequeue().animate(n,{duration:e||0,complete:function(){i(),$=!1,b[0].style.width=_.w+z+D+"px",b[0].style.height=_.h+N+j+"px",_.get("reposition")&&setTimeout(function(){I.bind("resize."+Z,J.position)},1),d.isFunction(t)&&t()},step:i})},J.resize=function(t){var e;U&&((t=t||{}).width&&(_.w=u(t.width,"x")-z-D),t.innerWidth&&(_.w=u(t.innerWidth,"x")),M.css({width:_.w}),t.height&&(_.h=u(t.height,"y")-N-j),t.innerHeight&&(_.h=u(t.innerHeight,"y")),t.innerHeight||t.height||(e=M.scrollTop(),M.css({height:"auto"}),_.h=M.height()),M.css({height:_.h}),e&&M.scrollTop(e),J.position("none"===_.get("transition")?0:_.get("speed")))},J.prep=function(t){if(U){var e,o="none"===_.get("transition")?0:_.get("speed");M.remove(),(M=l(st,"LoadedContent").append(t)).hide().appendTo(L.show()).css({width:(_.w=_.w||M.width(),_.w=_.mw&&_.mw<_.w?_.mw:_.w,_.w),overflow:_.get("scrolling")?"auto":"hidden"}).css({height:(_.h=_.h||M.height(),_.h=_.mh&&_.mh<_.h?_.mh:_.h,_.h)}).prependTo(T),L.hide(),d(q).css({float:"none"}),w(_.get("className")),e=function(){function t(){!1===d.support.opacity&&y[0].style.removeAttribute("filter")}var e,i,n=E.length;U&&(i=function(){clearTimeout(Q),F.hide(),v(nt),_.get("onComplete")},R.html(_.get("title")).show(),M.show(),1<n?("string"==typeof _.get("current")&&h.html(_.get("current").replace("{current}",A+1).replace("{total}",n)).show(),K[_.get("loop")||A<n-1?"show":"hide"]().html(_.get("next")),P[_.get("loop")||A?"show":"hide"]().html(_.get("previous")),ct(),_.get("preloading")&&d.each([r(-1),r(1)],function(){var t=E[this],e=new g(t,d.data(t,Y)),i=e.get("href");i&&f(e,i)&&(i=p(e,i),a.createElement("img").src=i)})):O.hide(),_.get("iframe")?(e=_.get("createIframe"),_.get("scrolling")||(e.scrolling="no"),d(e).attr({src:_.get("href"),class:Z+"Iframe"}).one("load",i).appendTo(M),at.one(ht,function(){e.src="//about:blank"}),_.get("fastIframe")&&d(e).trigger("load")):i(),"fade"===_.get("transition")?y.fadeTo(o,1,t):t())},"fade"===_.get("transition")?y.fadeTo(o,0,function(){J.position(0,e)}):J.position(o,e)}},J.next=function(){!$&&E[1]&&(_.get("loop")||E[A+1])&&(A=r(1),n(E[A]))},J.prev=function(){!$&&E[1]&&(_.get("loop")||A)&&(A=r(-1),n(E[A]))},J.close=function(){U&&!G&&(U=!(G=!0),v(ot),_.get("onCleanup"),I.unbind("."+Z),x.fadeTo(_.get("fadeOut")||0,0),y.stop().fadeTo(_.get("fadeOut")||0,0,function(){y.hide(),x.hide(),v(ht),M.remove(),setTimeout(function(){G=!1,v(rt),_.get("onClosed")},1)}))},J.remove=function(){y&&(y.stop(),d[Y].close(),y.stop(!1,!0).remove(),x.remove(),G=!1,y=null,d("."+tt).removeData(Y).removeClass(tt),d(a).unbind("click."+Z).unbind("keydown."+Z))},J.element=function(){return d(_.el)},J.settings=X)}(jQuery,document,window);
var Global={init:function(){}};$(document).ready(function(){Global.init()});
var Index=function(){var t,e=$(window).width(),o=$(window).height(),n=document.querySelector("#wrapper"),a=function(e){e?bodyScrollLock.disableBodyScroll(n):bodyScrollLock.enableBodyScroll(n)},i=function(e){t=e?(TweenLite.set("#nav .menu",{height:"auto"}),TweenLite.from("#nav .menu",.3,{height:0,ease:Power3.easeInOut}),!0):(TweenLite.to("#nav .menu",.3,{height:0,ease:Power3.easeInOut}),!1)},r=function(){var e=new ScrollMagic.Controller;scene=new ScrollMagic.Scene({triggerElement:".stage-1",triggerHook:"onLeave",offset:-1}).setPin(".intro").addTo(e),scene=new ScrollMagic.Scene({triggerElement:".trigger-1",triggerHook:"onCenter",duration:2e3}).setTween([tween=new TimelineMax,tween.staggerTo(".intro .text .erase",.5,{width:"100%",ease:Power3.easeInOut},.5).to(".intro .text p.mainland",.5,{autoAlpha:0,ease:Power3.easeInOut}).set(".intro .text .erase",{width:"0%"}).to(".intro .text .pgrpup",.5,{y:-72,ease:Power3.easeInOut},"t2").to(".intro .source .pgrpup",.5,{y:-44,ease:Power3.easeInOut},"t2").set(".intro .source .pgrpup p.taiwan",{className:"+=active"})]).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".trigger-2",triggerHook:"onCenter",duration:2e3}).setTween([tween=new TimelineMax,tween.staggerTo(".intro .text .erase",.5,{width:"100%",ease:Power3.easeInOut},.5).to(".intro .text p.taiwan",.5,{autoAlpha:0,ease:Power3.easeInOut}).set(".intro .text .erase",{width:"0%"}).to(".intro .text .pgrpup",.5,{y:-144,ease:Power3.easeInOut},"t").to(".intro .source .pgrpup",.5,{y:-88,ease:Power3.easeInOut},"t").set(".intro .source .pgrpup p.hongkong",{className:"+=active"})]).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".stage-2",triggerHook:"onEnter",duration:o}).setTween(TweenLite.to(".intro .mask",1,{autoAlpha:1,ease:Power3.easeInOut})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".history",triggerHook:"onLeave",offset:0,duration:$(".history").outerHeight()}).setTween(TweenLite.to("#nav .progress .bar",1,{scaleX:1,ease:Linear.easeNone})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".episode.ep-1",triggerHook:"onLeave",offset:-100,duration:100}).setTween([TweenLite.to("#nav .subtitle > div",1,{y:-30,ease:Power3.easeInOut}),TweenLite.from("#nav .progress",1,{scaleY:0,ease:Linear.easeNone})]).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".episode.ep-2",triggerHook:"onLeave",offset:-100,duration:100}).setTween(TweenLite.to("#title-group",1,{y:-30,ease:Power3.easeInOut})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".episode.ep-3",triggerHook:"onLeave",offset:-100,duration:100}).setTween(TweenLite.to("#title-group",1,{y:-60,ease:Power3.easeInOut})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".episode.ep-4",triggerHook:"onLeave",offset:-100,duration:100}).setTween(TweenLite.to("#title-group",1,{y:-90,ease:Power3.easeInOut})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".episode.ep-5",triggerHook:"onLeave",offset:-100,duration:100}).setTween(TweenLite.to("#title-group",1,{y:-120,ease:Power3.easeInOut})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".episode.ep-6",triggerHook:"onLeave",offset:-100,duration:100}).setTween(TweenLite.to("#title-group",1,{y:-150,ease:Power3.easeInOut})).addTo(e),scene=new ScrollMagic.Scene({triggerElement:".readmore",triggerHook:"onLeave",offset:-100,duration:100}).setTween([TweenLite.to("#nav .progress",1,{scaleY:0,ease:Linear.easeNone})]).addTo(e)},s=function(){!function(){var e=imagesLoaded("#wrapper"),i=0;e.on("always",function(){window.scrollTo(0,0)}),e.on("progress",function(e,t){var o,n=e.images.length;i++,o=Math.round(i/n*100),$(".percent span").html(o+"%")}),e.on("done",function(){timeline=(new TimelineMax).add(function(){a(!0)}).to(".loading",.5,{alpha:0,ease:Power3.easeIn}).set(".loading",{display:"none"}).add(function(){a(!1),r()})})}(),$("#nav .ep-title .title").on("click",function(){i(!!(t=!t))}),document.querySelectorAll("#nav .menu a.to-cate")[0].addEventListener("click",function(){TweenLite.to(window,1,{scrollTo:{y:".catalog",autoKill:!1},ease:Power3.easeInOut}),i(!1)}),document.querySelectorAll("#nav .menu a.title").forEach(function(e,t){e.addEventListener("click",function(){TweenLite.to(window,1,{scrollTo:{y:".episode.ep-"+(t+1),autoKill:!1},ease:Power3.easeInOut}),i(!1)})}),document.querySelectorAll(".main .catalog .grid hgroup").forEach(function(e,t){e.addEventListener("click",function(){TweenLite.to(window,1,{scrollTo:{y:".episode.ep-"+(t+1),autoKill:!1},ease:Power3.easeInOut})})}),767<e?$(".cbox").colorbox({inline:!0,width:600,opacity:.5,fixed:!0}):$(".cbox").colorbox({inline:!0,width:"90%",opacity:.5,fixed:!0}),$(document).bind("cbox_open",function(){a(!0)}).bind("cbox_closed",function(){a(!1)}),$(".submenu .mainland").click(function(){TweenLite.to(".history .content",.5,{scrollTo:{x:0,autoKill:!1},ease:Power3.easeInOut}),$(this).addClass("active").siblings().removeClass("active")}),$(".submenu .taiwan").click(function(){TweenLite.to(".history .content",.5,{scrollTo:{x:.833*e-60,autoKill:!1},ease:Power3.easeInOut}),$(this).addClass("active").siblings().removeClass("active")}),$(".submenu .hongkong").click(function(){TweenLite.to(".history .content",.5,{scrollTo:{x:1.666*e-60,autoKill:!1},ease:Power3.easeInOut}),$(this).addClass("active").siblings().removeClass("active")}),$(window).on("resize",function(){767<(e=$(window).width())&&location.reload()}),i(!1),window.onload=function(){var t=document.querySelectorAll(".footer__join");window.onscroll=function(e){window.innerHeight+window.scrollY>=document.body.offsetHeight?t[0].classList.add("active"):t[0].classList.remove("active")}}};return{init:function(){s()}}}();